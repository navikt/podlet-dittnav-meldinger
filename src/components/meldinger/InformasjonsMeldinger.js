  ...
  render() {
    ...
    if (this.props.visGenerellInfo) {
      ...
      children.push(
        ...
        <PanelMedIkon className="beskjed" overskrift={generellInfoOverskrift} key="generell" erInformasjonsmelding>
          <IkonBeskjed />
        </PanelMedIkon>
      );
    }
    ...
    if (this.props.isMeldeKortUser && this.props.visMeldekortbrukerInfo) {
      ...
      children.push(
        // eslint-disable-line function-paren-newline
        <PanelMedIkon className="beskjed" overskrift={meldekortOverskrift} key="melderkort" erInformasjonsmelding>
          <IkonBeskjed />
        </PanelMedIkon>
      );
    }
