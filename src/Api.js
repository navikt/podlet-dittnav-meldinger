...
export const fetchOppfolging = () => fetchJSON(Dittnav.OPPFOLGING_URL);
...
export const fetchSakstema = () => fetchJSON(Dittnav.SAKSTEMA_URL);

export const fetchInnloggingsstatus = () => fetchJSON(Innlogging.INNLOGGINGSSTATUS_URL);

export const fetchBeskjeder = () => fetchJSON(Dittnav.BESKJED_URL);

export const fetchOppgaver = () => fetchJSON(Dittnav.OPPGAVE_URL);

export const fetchInnbokser = () => fetchJSON(Dittnav.INNBOKS_URL);

export const fetchInaktiveBeskjeder = () => fetchJSON(Dittnav.BESKJED_INAKTIV_URL);

export const fetchInaktiveOppgaver = () => fetchJSON(Dittnav.OPPGAVE_INAKTIV_URL);

export const fetchInaktiveInnbokser = () => fetchJSON(Dittnav.INNBOKS_INAKTIV_URL);
