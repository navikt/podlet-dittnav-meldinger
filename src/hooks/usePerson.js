...
export const useIdent = (enabled) => [useQuery("ident", fetchPersonIdent, { enabled, onError: useStore().setError })];

export const useNavn = () => [useQuery("navn", fetchPersonNavn, { onError: useStore().setError })];

const usePerson = () => [useOppfolging(), useMeldekort(), useMeldinger(), useNavn()];
